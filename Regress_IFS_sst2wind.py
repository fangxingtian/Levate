...
def data_dict(myid):
    ...
    if myid == 'sst':
        mydict = {
            'indir': '/scratch/b/b381639/IFS',
            'infile': '/scratch/b/b381639/IFS/sst_daily_tco1279-orca025_tropical.nc',
...
##readin sfcwind
datasets=['sst','wsp10']  #['ERAI']  # ['u-bt405','u-bt406','u-bm213','u-be034','u-bd818']
...
iris.save(regyonx,mydict['indir']+'/regress_sst2wsp10_IFS.nc')
